...
int main(){
    ...
    oke = &nilai[0]; // "oke" sekarang menyimpan alamat dari nilai[0]
    /*ilustrasi
    ...
    // Jadi p1 dan p3 sama. dan p2 berbeda
    /*ilustrasi
    p1 = 1000
    p2 = 2000
    p3 = 1000*/
    ...
    if (p1 == p3) {
        cout << "p1 dan p3 menujuk ke alamat yang sama." << endl;
    }
    if (p1 != p2) {
        cout << "p1 dan p2 menujuk ke alamat yang berbeda." << endl;
    }

    int *p4 = NULL; // pointer tidak menunjuk ke alamat manapun
    if (p4 == NULL) {
